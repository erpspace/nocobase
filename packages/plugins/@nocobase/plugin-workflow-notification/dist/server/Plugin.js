...
var import_NotificationInstruction = __toESM(require("./NotificationInstruction"));
class Plugin_default extends import_server.Plugin {
  async load() {
    const workflowPlugin = this.app.pm.get(import_plugin_workflow.default);
    workflowPlugin.registerInstruction("notification", import_NotificationInstruction.default);
  }
}

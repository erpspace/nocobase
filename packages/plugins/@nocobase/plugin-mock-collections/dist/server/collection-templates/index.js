...
var collection_templates_exports = {};
__export(collection_templates_exports, {
  default: () => collection_templates_default
});
module.exports = __toCommonJS(collection_templates_exports);
var collection_templates_default = {
  calendar: (options) => {
    return {
      fields: [

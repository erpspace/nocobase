...
var multipleSelect_exports = {};
__export(multipleSelect_exports, {
...
const multipleSelect = {
  ...
  mock: (options) => {
    var _a;
    return import_faker.faker.helpers.arrayElements(import_lodash.default.map((_a = options == null ? void 0 : options.uiSchema) == null ? void 0 : _a.enum, import_lodash.default.property("value")));
  }
};

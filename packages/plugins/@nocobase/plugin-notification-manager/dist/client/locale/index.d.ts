...
export declare function useNotificationTranslation(): import("react-i18next").UseTranslationResponse<("notification-manager" | "client" | "data-source-manager")[], undefined>;

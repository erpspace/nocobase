...
__reExport(interfaces_exports, require("./base-interface"), module.exports);
__reExport(interfaces_exports, require("./percent-interface"), module.exports);

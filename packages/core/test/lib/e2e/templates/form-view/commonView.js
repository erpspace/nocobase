...
__export(commonView_exports, {
  commonFormViewPage: () => commonFormViewPage
});
module.exports = __toCommonJS(commonView_exports);
var import_templatesOfCollection = require("../../templatesOfCollection");
const commonFormViewPage = {
  collections: import_templatesOfCollection.generalWithBasic,
  pageSchema: {

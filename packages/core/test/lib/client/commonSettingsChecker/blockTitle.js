...
var blockTitle_exports = {};
__export(blockTitle_exports, {
  checkBlockTitle: () => checkBlockTitle
});
module.exports = __toCommonJS(blockTitle_exports);
...
__name(checkBlockTitle, "checkBlockTitle");
